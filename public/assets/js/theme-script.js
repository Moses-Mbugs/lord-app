...
document
    .querySelector("html")
    .setAttribute("data-modals", localStorage.getItem("layout") || "default");
document
    .querySelector("html")
    .setAttribute(
        "data-topbarcolor",
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function setThemeAndSidebarTheme(
        ...
        document.documentElement.setAttribute("data-modals", layout);
        ...
        if (width === "box") {
            document.body.classList.add("modals-box-mode");
            document.body.classList.add("mini-sidebar");
            layout_mini = 1;
        } else {
            if (layout_mini == 0) {
        ...
        // Show/hide sidebar background options based on modals selection
    ...
    function handleInputChange() {
        ...
        if (
            document.querySelector('input[name="topbarcolor"]:checked') != null
        ) {
    ...
    if (document.getElementById(`${savedTopbarcolor}Topbarcolor`)) {
        document.getElementById(`${savedTopbarcolor}Topbarcolor`).checked =
            true;
    }
    ...
    // Initially hide sidebar background options based on modals
